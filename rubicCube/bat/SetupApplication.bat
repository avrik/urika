...
:: Android packaging
set AND_CERT_NAME="RubicCube"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\RubicCube.p12
...
set IOS_PROVISION=cert\RubicCube.mobileprovision
...
set APP_ID=air.RubicCube

:: Output packages
set DIST_PATH=dist
set DIST_NAME=RubicCube

:: Debugging using a custom IP
set DEBUG_IP=10.0.0.1
