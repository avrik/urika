...
:: Android packaging
set AND_CERT_NAME="PokerSwipe"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PokerSwipe.p12
...
set IOS_PROVISION=cert\PokerSwipe.mobileprovision
...
set APP_ID=air.PokerSwipe

:: Output packages
set DIST_PATH=dist
set DIST_NAME=PokerSwipe
